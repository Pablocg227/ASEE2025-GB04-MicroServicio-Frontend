                                ...
                                purchasedSongs.length > 0 ? (
                                    purchasedSongs.map(song => (
                                        <div 
                                            ...
                                            // CORRECCIÓN 1: Ruta actualizada para canciones
                                ...
                                purchasedAlbums.length > 0 ? (
                                    purchasedAlbums.map(album => (
                                        <div 
                                            key={album.id} 
                                            className="purchase-card"
                                            // CORRECCIÓN 2: Ruta actualizada para álbumes
                                            onClick={() => navigate(`/musica/album/${album.id}`)}
                                        >
                                            <div className="card-image">
                                                <img 
                                                ...
                                                {(() => {
                                                    ...
                                                    return topSongs.map((song, index) => {
                                                        ...
                                                        return (
                                                            <div 
                                                                key={song.id || index} 
                                                                // CORRECCIÓN 3: Ruta actualizada para ranking
                                                                onClick={() => navigate(`/musica/cancion/${song.id}`)}
                                                                style={{
                                                                    display: 'grid',
                                                                    gridTemplateColumns: 'minmax(40px, 60px) minmax(60px, 80px) minmax(200px, 1fr) minmax(150px, 0.8fr) minmax(140px, 200px)',
